...
//Rendering data to the visible screen
function show(data){
    ...
    function loadUserData(page){
        ...
        //-fixedUsers here to remove it after the first page but did not work
        ...
        for (let i = startIndex; i < endIndex; i++){
            ...
            //appending the userElement as a last child to the userData element
        }
    }
