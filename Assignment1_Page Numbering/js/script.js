...
function show(data){
    ...
    //<ChatGPT May 12 Version https://chat.openai.com/> I was able to fetch the data but did not know how render it visible, I attempted many tries with my own code and knowledge, but it still did not work
    ...
    //<ChatGPT May 12 Version https://chat.openai.com/> I struggled quite a bit with the date because in the API provided, there were no formatted structure with the date and there were other numbers, letters that comes after it.
